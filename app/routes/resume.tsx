...
export const meta = () => [
  ...
  { name: "description", content: "ATS score and Resume preview" },
];
...
const Resume = () => {
  ...
  useEffect(() => {
    const loadResume = async () => {
      ...
      if (!resumeBlob) return setLoadError("Failed to load resume file.");
      ...
      if (!imageBlob) return setLoadError("Failed to load resume preview.");
      ...
      if (!data.feedback) {
        return setLoadError(
          "Analysis for this resume never completed. Please upload it again.",
        );
      }
